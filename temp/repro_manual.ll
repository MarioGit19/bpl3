...
define i32 @main() {
entry:
  %p_ptr = alloca %struct.Point, align 8
  
  %ptr_x = getelementptr inbounds %struct.Point, %struct.Point* %p_ptr, i32 0, i32 0
  store double 10.5, double* %ptr_x
  %ptr_y = getelementptr inbounds %struct.Point, %struct.Point* %p_ptr, i32 0, i32 1
  store double 20.5, double* %ptr_y
  %ptr_z = getelementptr inbounds %struct.Point, %struct.Point* %p_ptr, i32 0, i32 2
  store double 30.5, double* %ptr_z
